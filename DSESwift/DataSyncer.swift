...
//                    let sensor = Sensor(name: "light", sensorOptions: sensorOptions, userId:KeychainWrapper.stringForKey(KEYCHAIN_USERID)!, source: SOURCE, csDataPointsDownloaded: false )
//                    do{
