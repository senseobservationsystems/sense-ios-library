...
@objc public class DSEConfig: NSObject{
    public var uploadInterval: Double = 30 * 60// amount of seconds between upload sessions (default: 30 minutes)
    public var localPersistancePeriod: Double = 30 * 24 * 60 * 60 // amount of seconds to persist history (default: 30 days)
    public var enableSync: Bool = true // whether enable the periodic sync or not (default: true)
