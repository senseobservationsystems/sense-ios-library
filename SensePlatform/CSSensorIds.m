...
NSString* const kCSSENSOR_COMPASS = @"compass";
NSString* const kCSSENSOR_CONNECTION_TYPE = @"connection type";
NSString* const kCSSENSOR_LOCATION = @"position";
NSString* const kCSSENSOR_MISC = @"miscellaneous";
NSString* const kCSSENSOR_NOISE = @"noise";
...
NSString* const kCSSENSOR_SCREEN_STATE = @"screen";
