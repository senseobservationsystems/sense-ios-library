...
#ifndef sense_platform_library_SensorIds_h
#define sense_platform_library_SensorIds_h
...
extern NSString* const kCSSENSOR_ACTIVITY;
...
extern NSString* const kCSSENSOR_COMPASS;
extern NSString* const kCSSENSOR_CONNECTION_TYPE;
extern NSString* const kCSSENSOR_LOCATION;
extern NSString* const kCSSENSOR_MISC;
extern NSString* const kCSSENSOR_MOTION_ENERGY;
...
extern NSString* const kCSSENSOR_TIME;
